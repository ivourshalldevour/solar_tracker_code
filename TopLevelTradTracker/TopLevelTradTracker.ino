...
void setup() {
  ...
  rtcSetupCountdown(10, 15, RTC_ADDRESS);  // also clears CTAF and CTBF
...
void loop() {
  if (rtc_interrupt == 1) {
    ...
    Serial.print("theta0: ");
    Serial.println((int8_t)theta0);
    Serial.print("theta1: ");
    Serial.println((int8_t)theta1);
